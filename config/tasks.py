...
IMDB_TASK: Task = Task(dataset_name = "imdb", dataset_train = "train", dataset_val = "train", dataset_test = "test",
                       ...
                       distilbert_base_model = "distilbert/distilbert-base-uncased", is_llama_set_max_len = True,
                       llama_explained_tokenizer_max_length = 400, llama_explainer_tokenizer_max_length = 405,
                       bert_base_model = "bert-base-uncased", labels_str_int_maps = dict(negative = 0, positive = 1),
                       default_lr = 4e-5, llama_lr = 8e-5, test_sample = 2_000, train_sample = 800,
                       hp_search_test_sample = 200, hp_search_train_sample = 400, name = "imdb",
                       hp_search_n_trials = 40, llama_is_for_seq_class = False,
                       llama_model = "/tmp/meta-llama_Llama-2-7b-hf",
...
EMOTION_TASK: Task = Task(dataset_name = "emotion", dataset_train = "train", dataset_val = "validation",
                          ...
                          bert_base_model = "bert-base-uncased", llama_model = "/tmp/meta-llama_Llama-2-7b-hf",
                          labels_str_int_maps = dict(sadness = 0, joy = 1, love = 2, anger = 3, fear = 4, surprise = 5),
                          default_lr = 4e-5, llama_lr = 8e-5, test_sample = None, train_sample = 800,
                          hp_search_test_sample = 200, hp_search_train_sample = 400, name = "emotions",
                          hp_search_n_trials = 40, llama_is_for_seq_class = True,
...
SST_TASK: Task = Task(dataset_name = "sst2", dataset_train = "train", dataset_val = "train",
                      ...
                      llama_model = "/tmp/meta-llama_Llama-2-7b-hf", labels_str_int_maps = dict(n = 0, p = 1),
                      ...
                      train_sample = 800, hp_search_test_sample = 200, hp_search_train_sample = 400, name = "sst",
                      hp_search_n_trials = 40, llama_is_for_seq_class = False,
...
AGN_TASK: Task = Task(dataset_name = "ag_news", dataset_train = "train", dataset_val = "train", dataset_test = "test",
                      ...
                      distilbert_fine_tuned_model = '/tmp/trained_base_models/agn_distillbert/last_ckp',
                      default_lr = 4e-5, llama_lr = 8e-5, test_sample = 2_000, train_sample = 800,
                      hp_search_test_sample = 200, hp_search_train_sample = 400, name = "agn", hp_search_n_trials = 40,
                      llama_is_for_seq_class = True, llama_model = "/tmp/meta-llama_Llama-2-7b-hf",
...
RTN_TASK: Task = Task(dataset_name = "rotten_tomatoes", dataset_train = "train", dataset_val = "validation",
                      ...
                      bert_base_model = "bert-base-uncased", labels_str_int_maps = dict(negative = 0, positive = 1),
                      default_lr = 4e-5, llama_lr = 8e-5, test_sample = None, train_sample = 800,
                      hp_search_test_sample = 200, hp_search_train_sample = 400, name = "rtm", hp_search_n_trials = 40,
